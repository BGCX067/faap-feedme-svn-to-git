...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	if (bundle == null) {
	    ...
	    title = bundle
		    .getString(de.faap.feedme.ui.DashboardActivity.ACTIONBAR_TITLE);
	    icon = bundle
		    .getInt(de.faap.feedme.ui.DashboardActivity.ACTIONBAR_ICON);
	}
	...
	if (itemId == android.R.id.home) {
		...
		actionButton.setOnClickListener(new View.OnClickListener() {
			...
			mActivity.onMenuItemSelected(
				Window.FEATURE_OPTIONS_PANEL, item);
		    }
		});
	    }
